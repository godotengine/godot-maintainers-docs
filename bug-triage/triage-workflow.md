...
1. Confirm that the issue is valid and filled in properly
2. Do an initial assessment of the issue
3. Test the issue, or ask someone else to test it
4. Complete the assessment of the issue based on testing
5. Hand the issue over to the relevant team(s)
...
Issues that are clearly spam should be closed and tagged as “spam”.
